...
echo ""
echo "Next steps:"
echo "   1. Run ./create-geda-aid.sh to create the GEDA AID"
echo "   2. Run ./create-qvi-aid.sh to create the QVI AID"
echo "   3. Run ./create-le-aid.sh to create the LE AID"
echo "   4. Run ./create-person-aid.sh to create the Person AID"
echo "   5. Run ./create-qvi-acdc-credential.sh to issue QVI credential"
echo "   6. Run ./create-le-acdc-credential.sh to issue LE credential"
echo "   7. Run ./create-oor-acdc-credential.sh to issue OOR credentials"
echo ""
